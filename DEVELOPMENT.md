# DEVELOPMENT.md - Development Guide for Unified Public Data
...
- `automation/*` - Feature branches created by automation
- Branch naming: `automation/<feature>-<session-id>`
...
### Current Branch
```bash
feature/initial-setup-development-guide
```
...
**automation Session**: 011CUxmC9PrpR4DkfxkTWSjm
